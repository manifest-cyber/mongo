...
def grpc_deps():
    ...
    if "build_bazel_rules_apple" not in native.existing_rules():
        http_archive(
            ...
            sha256 = "01942ba864b2718aedf2c19c8b2e969beac93ec91b388a1d19a48fa31c5cac49",
            urls = [
                "https://storage.googleapis.com/grpc-bazel-mirror/github.com/bazelbuild/rules_apple/releases/download/5.0.0/rules_apple.5.0.0.tar.gz",
                "https://github.com/bazelbuild/rules_apple/releases/download/5.0.0/rules_apple.5.0.0.tar.gz",
            ],
        )
