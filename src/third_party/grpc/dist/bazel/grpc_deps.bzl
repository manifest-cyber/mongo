...
def grpc_module_deps():
    if "google_cloud_cpp" not in native.existing_rules():
        http_archive(
            ...
            sha256 = "5e4e179531cd947e9d6893d0fcefcf2b3631b4e182f424138dbb2b7dd5334ce4",
            strip_prefix = "google-cloud-cpp-3.9.0",
            urls = [
                "https://storage.googleapis.com/grpc-bazel-mirror/github.com/googleapis/google-cloud-cpp/archive/refs/tags/v3.9.0.tar.gz",
                "https://github.com/googleapis/google-cloud-cpp/archive/refs/tags/v3.9.0.tar.gz",
            ],
        )
