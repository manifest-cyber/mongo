...
def grpc_module_deps():
    if "google_cloud_cpp" not in native.existing_rules():
        http_archive(
            ...
            urls = [
                "https://storage.googleapis.com/grpc-bazel-mirror/github.com/googleapis/google-cloud-cpp/archive/refs/tags/v3.8.0.tar.gz",
                "https://github.com/googleapis/google-cloud-cpp/archive/refs/tags/v3.8.0.tar.gz",
            ],
        )
