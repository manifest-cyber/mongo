...
def grpc_deps():
    ...
    if "build_bazel_apple_support" not in native.existing_rules():
        http_archive(
            ...
            sha256 = "fe45a2a78d12e9683fbe3ca53c55e0238dff702fa0b2f451f1ef339fc400f478",
            urls = [
                "https://storage.googleapis.com/grpc-bazel-mirror/github.com/bazelbuild/apple_support/releases/download/2.8.4/apple_support.2.8.4.tar.gz",
                "https://github.com/bazelbuild/apple_support/releases/download/2.8.4/apple_support.2.8.4.tar.gz",
            ],
        )
